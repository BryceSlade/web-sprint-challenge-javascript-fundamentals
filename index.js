...
// nestedFunction() can access the variable internal because it is within the same scope. It can reach out to grab variables.
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      scientificNames.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    });
